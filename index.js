...
var ASM_CONSTS = {
  118360: () => { if (document.fullscreenElement) return 1; },  
 118406: () => { return document.getElementById('canvas').width; },  
 118458: () => { return parseInt(document.getElementById('canvas').style.width); },  
 118526: () => { document.exitFullscreen(); },  
 118553: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 118626: () => { if (document.fullscreenElement) return 1; },  
 118672: () => { return document.getElementById('canvas').width; },  
 118724: () => { return screen.width; },  
 118749: () => { document.exitFullscreen(); },  
 118776: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 118909: () => { return window.innerWidth; },  
 118935: () => { return window.innerHeight; },  
 118962: () => { if (document.fullscreenElement) return 1; },  
 119008: () => { return document.getElementById('canvas').width; },  
 119060: () => { return parseInt(document.getElementById('canvas').style.width); },  
 119128: () => { if (document.fullscreenElement) return 1; },  
 119174: () => { return document.getElementById('canvas').width; },  
 119226: () => { return screen.width; },  
 119251: () => { return window.innerWidth; },  
 119277: () => { return window.innerHeight; },  
 119304: () => { if (document.fullscreenElement) return 1; },  
 119350: () => { return document.getElementById('canvas').width; },  
 119402: () => { return screen.width; },  
 119427: () => { document.exitFullscreen(); },  
 119454: () => { if (document.fullscreenElement) return 1; },  
 119500: () => { return document.getElementById('canvas').width; },  
 119552: () => { return parseInt(document.getElementById('canvas').style.width); },  
 119620: () => { document.exitFullscreen(); },  
 119647: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 119705: () => { return screen.width; },  
 119730: () => { return screen.height; },  
 119756: () => { return window.screenX; },  
 119783: () => { return window.screenY; },  
 119810: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 119863: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 119934: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 119991: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 120247: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 120318: () => { if (document.fullscreenElement) return 1; },  
 120364: () => { return window.innerWidth; },  
 120390: () => { return window.innerHeight; },  
 120417: () => { if (document.pointerLockElement) return 1; }
};
